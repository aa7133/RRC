...
struct MBSFNAreaConfiguration_r9;
struct MBMSCountingRequest_r10;
	...
	union MCCH_MessageType_u {
		struct MCCH_MessageType__c1 {
			...
			union MCCH_MessageType__c1_u {
				struct MBSFNAreaConfiguration_r9	*mbsfnAreaConfiguration_r9;
			} choice;
			...
			union MCCH_MessageType__later_u {
				struct MCCH_MessageType__later__c2 {
					...
					union MCCH_MessageType__later__c2_u {
						struct MBMSCountingRequest_r10	*mbmsCountingRequest_r10;
					} choice;
