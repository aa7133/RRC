...
static asn_TYPE_member_t asn_MBR_speedStatePars_12[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct MeasConfig__speedStatePars, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_14,
		0,
...
static asn_TYPE_member_t asn_MBR_heightThreshRef_r15_42[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MeasConfig__ext7__heightThreshRef_r15, choice.setup),
		...
		0,
		{ 0, &asn_PER_memb_setup_constr_44,  memb_setup_constraint_42 },
		0, 0, /* No default value */
		"setup"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_heightThreshRef_r15_42 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_heightThreshRef_r15_constr_42, CHOICE_constraint },
