...
struct RRCConnectionResumeRequest_r13_IEs;
struct RRCConnectionResumeRequest_5GC_r15_IEs;
...
typedef struct RRCConnectionResumeRequest_r13 {
	struct RRCConnectionResumeRequest_r13__criticalExtensions {
		...
		union RRCConnectionResumeRequest_r13__criticalExtensions_u {
			struct RRCConnectionResumeRequest_r13_IEs	*rrcConnectionResumeRequest_r13;
			struct RRCConnectionResumeRequest_5GC_r15_IEs	*rrcConnectionResumeRequest_r15;
		} choice;
