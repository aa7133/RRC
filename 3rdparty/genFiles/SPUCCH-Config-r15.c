...
asn_TYPE_descriptor_t asn_DEF_twoAntennaPortActivatedSPUCCH_Format1a1b_r15_5 = {
	...
	{ 0, &asn_PER_type_twoAntennaPortActivatedSPUCCH_Format1a1b_r15_constr_5, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_n3SPUCCH_AN_List_r15_8 = {
	...
	{ 0, &asn_PER_type_n3SPUCCH_AN_List_r15_constr_8, SEQUENCE_OF_constraint },
...
static asn_TYPE_member_t asn_MBR_dummy_7[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SPUCCH_Config_r15__setup__dummy, n3SPUCCH_AN_List_r15),
		...
		0,
		{ 0, &asn_PER_memb_n3SPUCCH_AN_List_r15_constr_8,  memb_n3SPUCCH_AN_List_r15_constraint_7 },
		0, 0, /* No default value */
		"n3SPUCCH-AN-List-r15"
		},
};
...
asn_TYPE_member_t asn_MBR_SPUCCH_Config_r15_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct SPUCCH_Config_r15, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_3,
		0,
...
asn_TYPE_descriptor_t asn_DEF_SPUCCH_Config_r15 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_SPUCCH_Config_r15_constr_1, CHOICE_constraint },
