...
static asn_TYPE_member_t asn_MBR_csi_SubframePatternDormant_r15_6[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct CQI_ReportPeriodicSCell_r15__setup__csi_SubframePatternDormant_r15, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_8,
		0,
...
asn_TYPE_descriptor_t asn_DEF_csi_SubframePatternDormant_r15_6 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_csi_SubframePatternDormant_r15_constr_6, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_csi_ReportMode_r15_13 = {
	...
	{ 0, &asn_PER_type_csi_ReportMode_r15_constr_13, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_periodicityFactor_r15_18 = {
	...
	{ 0, &asn_PER_type_periodicityFactor_r15_constr_18, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
static asn_TYPE_member_t asn_MBR_subbandCQI_r15_16[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CQI_ReportPeriodicSCell_r15__setup__cqi_FormatIndicatorDormant_r15__subbandCQI_r15, k_r15),
		...
		0,
		{ 0, &asn_PER_memb_k_r15_constr_17,  memb_k_r15_constraint_16 },
		0, 0, /* No default value */
		"k-r15"
		},
...
static asn_TYPE_member_t asn_MBR_cqi_FormatIndicatorDormant_r15_11[] = {
	{ ATF_POINTER, 0, offsetof(struct CQI_ReportPeriodicSCell_r15__setup__cqi_FormatIndicatorDormant_r15, choice.widebandCQI_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct CQI_ReportPeriodicSCell_r15__setup__cqi_FormatIndicatorDormant_r15, choice.subbandCQI_r15),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
asn_TYPE_descriptor_t asn_DEF_cqi_FormatIndicatorDormant_r15_11 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_cqi_FormatIndicatorDormant_r15_constr_11, CHOICE_constraint },
...
static asn_TYPE_member_t asn_MBR_setup_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CQI_ReportPeriodicSCell_r15__setup, cqi_pmi_ConfigIndexDormant_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_cqi_pmi_ConfigIndexDormant_r15_constr_4,  memb_cqi_pmi_ConfigIndexDormant_r15_constraint_3 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 3, offsetof(struct CQI_ReportPeriodicSCell_r15__setup, ri_ConfigIndexDormant_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_ri_ConfigIndexDormant_r15_constr_5,  memb_ri_ConfigIndexDormant_r15_constraint_3 },
		0, 0, /* No default value */
...
asn_TYPE_member_t asn_MBR_CQI_ReportPeriodicSCell_r15_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct CQI_ReportPeriodicSCell_r15, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_3,
		0,
...
asn_TYPE_descriptor_t asn_DEF_CQI_ReportPeriodicSCell_r15 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_CQI_ReportPeriodicSCell_r15_constr_1, CHOICE_constraint },
