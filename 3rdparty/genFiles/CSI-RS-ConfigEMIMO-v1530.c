...
static asn_TYPE_member_t asn_MBR_setup_3[] = {
	{ ATF_POINTER, 0, offsetof(struct CSI_RS_ConfigEMIMO_v1530__setup, choice.nonPrecoded_v1530),
...
asn_TYPE_member_t asn_MBR_CSI_RS_ConfigEMIMO_v1530_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct CSI_RS_ConfigEMIMO_v1530, choice.setup),
...
asn_TYPE_descriptor_t asn_DEF_CSI_RS_ConfigEMIMO_v1530 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_CSI_RS_ConfigEMIMO_v1530_constr_1, CHOICE_constraint },
