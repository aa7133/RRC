...
static asn_TYPE_member_t asn_MBR_mode_r15_2[] = {
	{ ATF_POINTER, 0, offsetof(struct RLC_Config_r15__mode_r15, choice.am_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_am_r15_3,
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct RLC_Config_r15__mode_r15, choice.um_Bi_Directional_r15),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct RLC_Config_r15__mode_r15, choice.um_Uni_Directional_UL_r15),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct RLC_Config_r15__mode_r15, choice.um_Uni_Directional_DL_r15),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
