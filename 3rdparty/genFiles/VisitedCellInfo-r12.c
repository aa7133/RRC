...
static asn_TYPE_member_t asn_MBR_visitedCellId_r12_2[] = {
	{ ATF_POINTER, 0, offsetof(struct VisitedCellInfo_r12__visitedCellId_r12, choice.cellGlobalId_r12),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 0, offsetof(struct VisitedCellInfo_r12__visitedCellId_r12, choice.pci_arfcn_r12),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
