...
asn_TYPE_member_t asn_MBR_TDM_AssistanceInfo_r11_1[] = {
	{ ATF_POINTER, 0, offsetof(struct TDM_AssistanceInfo_r11, choice.drx_AssistanceInfo_r11),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct TDM_AssistanceInfo_r11, choice.idc_SubframePatternList_r11),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
