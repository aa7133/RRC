...
static asn_TYPE_member_t asn_MBR_purpose_3[] = {
	{ ATF_POINTER, 0, offsetof(struct MobilityFromEUTRACommand_r8_IEs__purpose, choice.handover),
	...
	{ ATF_POINTER, 0, offsetof(struct MobilityFromEUTRACommand_r8_IEs__purpose, choice.cellChangeOrder),
