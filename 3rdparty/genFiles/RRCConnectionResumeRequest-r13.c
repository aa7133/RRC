...
static asn_TYPE_member_t asn_MBR_criticalExtensions_2[] = {
	{ ATF_POINTER, 0, offsetof(struct RRCConnectionResumeRequest_r13__criticalExtensions, choice.rrcConnectionResumeRequest_r13),
	...
	{ ATF_POINTER, 0, offsetof(struct RRCConnectionResumeRequest_r13__criticalExtensions, choice.rrcConnectionResumeRequest_r15),
