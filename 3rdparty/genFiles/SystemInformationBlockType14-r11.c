...
static asn_TYPE_member_t asn_MBR_eab_Param_r11_2[] = {
	{ ATF_POINTER, 0, offsetof(struct SystemInformationBlockType14_r11__eab_Param_r11, choice.eab_Common_r11),
	...
	{ ATF_POINTER, 0, offsetof(struct SystemInformationBlockType14_r11__eab_Param_r11, choice.eab_PerPLMN_List_r11),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
asn_TYPE_descriptor_t asn_DEF_eab_PerRSRP_r15_9 = {
	...
	{ 0, &asn_PER_type_eab_PerRSRP_r15_constr_9, NativeEnumerated_constraint },
