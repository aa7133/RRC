...
static asn_TYPE_member_t asn_MBR_Member_2[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct CellsTriggeredList__Member, choice.physCellIdUTRA),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	...
	{ ATF_POINTER, 0, offsetof(struct CellsTriggeredList__Member, choice.physCellIdGERAN),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct CellsTriggeredList__Member, choice.wlan_Identifiers_r13),
	...
	{ ATF_POINTER, 0, offsetof(struct CellsTriggeredList__Member, choice.physCellIdNR_r15),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
