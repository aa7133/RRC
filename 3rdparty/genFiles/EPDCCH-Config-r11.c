...
static asn_TYPE_member_t asn_MBR_subframePatternConfig_r11_5[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct EPDCCH_Config_r11__config_r11__setup__subframePatternConfig_r11, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_7,
		0,
...
static asn_TYPE_member_t asn_MBR_config_r11_2[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct EPDCCH_Config_r11__config_r11, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_4,
		0,
