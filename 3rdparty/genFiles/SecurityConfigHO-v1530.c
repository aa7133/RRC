...
static asn_TYPE_member_t asn_MBR_handoverType_v1530_2[] = {
	{ ATF_POINTER, 0, offsetof(struct SecurityConfigHO_v1530__handoverType_v1530, choice.intra5GC_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct SecurityConfigHO_v1530__handoverType_v1530, choice.fivegc_ToEPC_r15),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct SecurityConfigHO_v1530__handoverType_v1530, choice.epc_To5GC_r15),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
...
asn_TYPE_descriptor_t asn_DEF_handoverType_v1530_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_handoverType_v1530_constr_2, CHOICE_constraint },
