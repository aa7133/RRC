...
static asn_TYPE_member_t asn_MBR_setup_3[] = {
	{ ATF_POINTER, 0, offsetof(struct CSI_RS_ConfigEMIMO_v1480__setup, choice.nonPrecoded_v1480),
	...
	{ ATF_POINTER, 0, offsetof(struct CSI_RS_ConfigEMIMO_v1480__setup, choice.beamformed_v1480),
...
asn_TYPE_member_t asn_MBR_CSI_RS_ConfigEMIMO_v1480_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct CSI_RS_ConfigEMIMO_v1480, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
...
asn_TYPE_descriptor_t asn_DEF_CSI_RS_ConfigEMIMO_v1480 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_CSI_RS_ConfigEMIMO_v1480_constr_1, CHOICE_constraint },
