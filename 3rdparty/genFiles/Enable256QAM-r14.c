...
static asn_TYPE_member_t asn_MBR_setup_3[] = {
	{ ATF_POINTER, 0, offsetof(struct Enable256QAM_r14__setup, choice.tpc_SubframeSet_Configured_r14),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct Enable256QAM_r14__setup, choice.tpc_SubframeSet_NotConfigured_r14),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
asn_TYPE_member_t asn_MBR_Enable256QAM_r14_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct Enable256QAM_r14, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
