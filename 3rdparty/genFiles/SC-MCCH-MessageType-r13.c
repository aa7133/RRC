...
static asn_TYPE_member_t asn_MBR_c1_2[] = {
	{ ATF_POINTER, 0, offsetof(struct SC_MCCH_MessageType_r13__c1, choice.scptmConfiguration_r13),
...
static asn_TYPE_member_t asn_MBR_c2_5[] = {
	{ ATF_POINTER, 0, offsetof(struct SC_MCCH_MessageType_r13__messageClassExtension__c2, choice.scptmConfiguration_BR_r14),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_TYPE_member_t asn_MBR_messageClassExtension_4[] = {
	{ ATF_POINTER, 0, offsetof(struct SC_MCCH_MessageType_r13__messageClassExtension, choice.c2),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 0, offsetof(struct SC_MCCH_MessageType_r13__messageClassExtension, choice.messageClassExtensionFuture_r14),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
asn_TYPE_member_t asn_MBR_SC_MCCH_MessageType_r13_1[] = {
	{ ATF_POINTER, 0, offsetof(struct SC_MCCH_MessageType_r13, choice.c1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_c1_2,
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct SC_MCCH_MessageType_r13, choice.messageClassExtension),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		+1,	/* EXPLICIT tag at current level */
