...
static asn_TYPE_member_t asn_MBR_operationModeInfo_r13_7[] = {
	{ ATF_POINTER, 0, offsetof(struct MasterInformationBlock_NB__operationModeInfo_r13, choice.inband_SamePCI_r13),
	...
	{ ATF_POINTER, 0, offsetof(struct MasterInformationBlock_NB__operationModeInfo_r13, choice.inband_DifferentPCI_r13),
	...
	{ ATF_POINTER, 0, offsetof(struct MasterInformationBlock_NB__operationModeInfo_r13, choice.guardband_r13),
	...
	{ ATF_POINTER, 0, offsetof(struct MasterInformationBlock_NB__operationModeInfo_r13, choice.standalone_r13),
