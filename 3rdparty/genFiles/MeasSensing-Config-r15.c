...
asn_TYPE_descriptor_t asn_DEF_sensingPeriodicity_r15_3 = {
	...
	{ 0, &asn_PER_type_sensingPeriodicity_r15_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_MeasSensing_Config_r15_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct MeasSensing_Config_r15, sensingSubchannelNumber_r15),
		...
		0,
		{ 0, &asn_PER_memb_sensingSubchannelNumber_r15_constr_2,  memb_sensingSubchannelNumber_r15_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MeasSensing_Config_r15, sensingReselectionCounter_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_sensingReselectionCounter_r15_constr_16,  memb_sensingReselectionCounter_r15_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MeasSensing_Config_r15, sensingPriority_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_sensingPriority_r15_constr_17,  memb_sensingPriority_r15_constraint_1 },
		0, 0, /* No default value */
		"sensingPriority-r15"
		},
};
