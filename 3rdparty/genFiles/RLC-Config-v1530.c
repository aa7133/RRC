...
asn_TYPE_descriptor_t asn_DEF_rlc_OutOfOrderDelivery_r15_4 = {
	...
	{ 0, &asn_PER_type_rlc_OutOfOrderDelivery_r15_constr_4, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_RLC_Config_v1530_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct RLC_Config_v1530, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_3,
		0,
...
asn_TYPE_descriptor_t asn_DEF_RLC_Config_v1530 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_RLC_Config_v1530_constr_1, CHOICE_constraint },
