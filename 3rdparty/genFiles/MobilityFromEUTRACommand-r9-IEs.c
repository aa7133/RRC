...
static asn_TYPE_member_t asn_MBR_purpose_3[] = {
	{ ATF_POINTER, 0, offsetof(struct MobilityFromEUTRACommand_r9_IEs__purpose, choice.handover),
	...
	{ ATF_POINTER, 0, offsetof(struct MobilityFromEUTRACommand_r9_IEs__purpose, choice.cellChangeOrder),
	...
	{ ATF_POINTER, 0, offsetof(struct MobilityFromEUTRACommand_r9_IEs__purpose, choice.e_CSFB_r9),
