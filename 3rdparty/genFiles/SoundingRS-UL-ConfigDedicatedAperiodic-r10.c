...
static asn_TYPE_member_t asn_MBR_srs_ActivateAp_r10_7[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct SoundingRS_UL_ConfigDedicatedAperiodic_r10__setup__srs_ActivateAp_r10, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_9,
		0,
...
asn_TYPE_member_t asn_MBR_SoundingRS_UL_ConfigDedicatedAperiodic_r10_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct SoundingRS_UL_ConfigDedicatedAperiodic_r10, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_3,
		0,
