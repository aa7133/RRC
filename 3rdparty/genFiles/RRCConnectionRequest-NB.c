...
static asn_TYPE_member_t asn_MBR_criticalExtensions_2[] = {
	{ ATF_POINTER, 0, offsetof(struct RRCConnectionRequest_NB__criticalExtensions, choice.rrcConnectionRequest_r13),
	...
	{ ATF_POINTER, 0, offsetof(struct RRCConnectionRequest_NB__criticalExtensions, choice.criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
