...
static asn_TYPE_member_t asn_MBR_c1_3[] = {
	{ ATF_POINTER, 0, offsetof(struct SidelinkUEInformation_r12__criticalExtensions__c1, choice.sidelinkUEInformation_r12),
...
static asn_TYPE_member_t asn_MBR_criticalExtensions_2[] = {
	{ ATF_POINTER, 0, offsetof(struct SidelinkUEInformation_r12__criticalExtensions, choice.c1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 0, offsetof(struct SidelinkUEInformation_r12__criticalExtensions, choice.criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
