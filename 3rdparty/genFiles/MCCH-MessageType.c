...
static asn_TYPE_member_t asn_MBR_c1_2[] = {
	{ ATF_POINTER, 0, offsetof(struct MCCH_MessageType__c1, choice.mbsfnAreaConfiguration_r9),
...
static asn_TYPE_member_t asn_MBR_c2_5[] = {
	{ ATF_POINTER, 0, offsetof(struct MCCH_MessageType__later__c2, choice.mbmsCountingRequest_r10),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_TYPE_member_t asn_MBR_later_4[] = {
	{ ATF_POINTER, 0, offsetof(struct MCCH_MessageType__later, choice.c2),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 0, offsetof(struct MCCH_MessageType__later, choice.messageClassExtension),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
asn_TYPE_member_t asn_MBR_MCCH_MessageType_1[] = {
	{ ATF_POINTER, 0, offsetof(struct MCCH_MessageType, choice.c1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_c1_2,
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct MCCH_MessageType, choice.later),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_later_4,
		0,
