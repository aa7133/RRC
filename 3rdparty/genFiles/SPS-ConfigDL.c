...
static asn_TYPE_member_t asn_MBR_twoAntennaPortActivated_r10_25[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct SPS_ConfigDL__setup__ext1__twoAntennaPortActivated_r10, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_27,
		0,
...
asn_TYPE_member_t asn_MBR_SPS_ConfigDL_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct SPS_ConfigDL, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_3,
		0,
