...
asn_TYPE_descriptor_t asn_DEF_edt_TBS_r15_31 = {
	...
	{ 0, &asn_PER_type_edt_TBS_r15_constr_31, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_mac_ContentionResolutionTimer_r15_40 = {
	...
	{ 0, &asn_PER_type_mac_ContentionResolutionTimer_r15_constr_40, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
static asn_TYPE_member_t asn_MBR_edt_Parameters_r15_28[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RACH_CE_LevelInfo_r13__ext1__edt_Parameters_r15, edt_LastPreamble_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_edt_LastPreamble_r15_constr_29,  memb_edt_LastPreamble_r15_constraint_28 },
		0, 0, /* No default value */
