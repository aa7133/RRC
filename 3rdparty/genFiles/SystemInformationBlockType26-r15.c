...
asn_TYPE_descriptor_t asn_DEF_slss_TxMultiFreq_r15_6 = {
	...
	{ 0, &asn_PER_type_slss_TxMultiFreq_r15_constr_6, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType26_r15_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType26_r15, threshS_RSSI_CBR_r14),
		...
		0,
		{ 0, &asn_PER_memb_threshS_RSSI_CBR_r14_constr_9,  memb_threshS_RSSI_CBR_r14_constraint_1 },
		0, 0, /* No default value */
