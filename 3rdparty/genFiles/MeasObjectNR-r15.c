...
asn_TYPE_descriptor_t asn_DEF_cellsForWhichToReportSFTD_r15_10 = {
	...
	{ 0, &asn_PER_type_cellsForWhichToReportSFTD_r15_constr_10, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_bandNR_r15_17 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_bandNR_r15_constr_17, CHOICE_constraint },
...
asn_TYPE_member_t asn_MBR_MeasObjectNR_r15_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MeasObjectNR_r15, quantityConfigSet_r15),
		...
		0,
		{ 0, &asn_PER_memb_quantityConfigSet_r15_constr_9,  memb_quantityConfigSet_r15_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 2, offsetof(struct MeasObjectNR_r15, cellsForWhichToReportSFTD_r15),
		...
		0,
		{ 0, &asn_PER_memb_cellsForWhichToReportSFTD_r15_constr_10,  memb_cellsForWhichToReportSFTD_r15_constraint_1 },
		0, 0, /* No default value */
		"cellsForWhichToReportSFTD-r15"
		},
