...
typedef struct MeasResults {
	...
	struct MeasResults__measResultNeighCells {
		...
		union MeasResults__measResultNeighCells_u {
			...
			struct MeasResultListUTRA	*measResultListUTRA;
			struct MeasResultListGERAN	*measResultListGERAN;
			struct MeasResultsCDMA2000	*measResultsCDMA2000;
			/*
			 * This type is extensible,
			 * possible extensions are below.
			 */
			struct MeasResultCellListNR_r15	*measResultNeighCellListNR_r15;
		} choice;
