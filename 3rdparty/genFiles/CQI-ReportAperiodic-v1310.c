...
static asn_TYPE_member_t asn_MBR_aperiodicCSI_Trigger2_r13_11[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct CQI_ReportAperiodic_v1310__setup__aperiodicCSI_Trigger2_r13, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_13,
		0,
...
asn_TYPE_member_t asn_MBR_CQI_ReportAperiodic_v1310_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct CQI_ReportAperiodic_v1310, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_3,
		0,
