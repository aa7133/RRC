...
asn_TYPE_descriptor_t asn_DEF_t301_v1530_55 = {
	...
	{ 0, &asn_PER_type_t301_v1530_constr_55, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_t311_v1530_59 = {
	...
	{ 0, &asn_PER_type_t311_v1530_constr_59, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_RLF_TimersAndConstants_NB_r13_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct RLF_TimersAndConstants_NB_r13, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_3,
		0,
