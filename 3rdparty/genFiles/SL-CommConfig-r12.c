...
static asn_TYPE_member_t asn_MBR_setup_4[] = {
	{ ATF_POINTER, 0, offsetof(struct SL_CommConfig_r12__commTxResources_r12__setup, choice.scheduled_r12),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct SL_CommConfig_r12__commTxResources_r12__setup, choice.ue_Selected_r12),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static asn_TYPE_member_t asn_MBR_commTxResources_r12_2[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct SL_CommConfig_r12__commTxResources_r12, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
...
static asn_TYPE_member_t asn_MBR_setup_18[] = {
	{ ATF_POINTER, 0, offsetof(struct SL_CommConfig_r12__ext1__commTxResources_v1310__setup, choice.scheduled_v1310),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct SL_CommConfig_r12__ext1__commTxResources_v1310__setup, choice.ue_Selected_v1310),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static asn_TYPE_member_t asn_MBR_commTxResources_v1310_16[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct SL_CommConfig_r12__ext1__commTxResources_v1310, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_setup_18,
		0,
