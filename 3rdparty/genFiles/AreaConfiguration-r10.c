...
asn_TYPE_member_t asn_MBR_AreaConfiguration_r10_1[] = {
	{ ATF_POINTER, 0, offsetof(struct AreaConfiguration_r10, choice.cellGlobalIdList_r10),
	...
	{ ATF_POINTER, 0, offsetof(struct AreaConfiguration_r10, choice.trackingAreaCodeList_r10),
