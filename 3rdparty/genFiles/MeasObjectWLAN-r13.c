...
static asn_TYPE_member_t asn_MBR_carrierFreq_r13_2[] = {
	{ ATF_POINTER, 0, offsetof(struct MeasObjectWLAN_r13__carrierFreq_r13, choice.bandIndicatorListWLAN_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct MeasObjectWLAN_r13__carrierFreq_r13, choice.carrierInfoListWLAN_r13),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
