...
struct SystemInformation_NB;
struct SystemInformationBlockType1_NB;
	...
	union BCCH_DL_SCH_MessageType_NB_u {
		struct BCCH_DL_SCH_MessageType_NB__c1 {
			...
			union BCCH_DL_SCH_MessageType_NB__c1_u {
				struct SystemInformation_NB	*systemInformation_r13;
				struct SystemInformationBlockType1_NB	*systemInformationBlockType1_r13;
			} choice;
