...
static asn_TYPE_member_t asn_MBR_followingARFCNs_4[] = {
	{ ATF_POINTER, 0, offsetof(struct CarrierFreqsGERAN__followingARFCNs, choice.explicitListOfARFCNs),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 0, offsetof(struct CarrierFreqsGERAN__followingARFCNs, choice.equallySpacedARFCNs),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
