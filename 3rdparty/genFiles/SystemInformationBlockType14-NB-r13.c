...
static asn_TYPE_member_t asn_MBR_ab_Param_r13_2[] = {
	{ ATF_POINTER, 0, offsetof(struct SystemInformationBlockType14_NB_r13__ab_Param_r13, choice.ab_Common_r13),
	...
	{ ATF_POINTER, 0, offsetof(struct SystemInformationBlockType14_NB_r13__ab_Param_r13, choice.ab_PerPLMN_List_r13),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
asn_TYPE_descriptor_t asn_DEF_ab_PerNRSRP_r15_9 = {
	...
	{ 0, &asn_PER_type_ab_PerNRSRP_r15_constr_9, NativeEnumerated_constraint },
