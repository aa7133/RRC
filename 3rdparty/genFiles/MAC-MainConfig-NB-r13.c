...
static asn_TYPE_member_t asn_MBR_logicalChannelSR_Config_r13_7[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct MAC_MainConfig_NB_r13__logicalChannelSR_Config_r13, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_9,
		0,
...
static asn_TYPE_member_t asn_MBR_dataInactivityTimerConfig_r14_23[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct MAC_MainConfig_NB_r13__ext1__dataInactivityTimerConfig_r14, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_25,
		0,
