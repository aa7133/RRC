...
typedef struct RedirectedCarrierInfo_r15_IEs {
	...
	union RedirectedCarrierInfo_r15_IEs_u {
		...
		struct CarrierFreqsGERAN	*geran_r15;
		ARFCN_ValueUTRA_t	 utra_FDD_r15;
		struct CarrierFreqCDMA2000	*cdma2000_HRPD_r15;
		struct CarrierFreqCDMA2000	*cdma2000_1xRTT_r15;
		struct CarrierFreqListUTRA_TDD_r10	*utra_TDD_r15;
	} choice;
