...
static asn_TYPE_member_t asn_MBR_srs_ActivateAp_v1310_6[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct SoundingRS_UL_ConfigDedicatedAperiodic_v1310__setup__srs_ActivateAp_v1310, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_8,
		0,
...
asn_TYPE_member_t asn_MBR_SoundingRS_UL_ConfigDedicatedAperiodic_v1310_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct SoundingRS_UL_ConfigDedicatedAperiodic_v1310, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_3,
		0,
