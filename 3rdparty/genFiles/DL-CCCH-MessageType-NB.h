...
struct RRCConnectionReestablishment_NB;
struct RRCConnectionReestablishmentReject;
struct RRCConnectionReject_NB;
struct RRCConnectionSetup_NB;
struct RRCEarlyDataComplete_NB_r15;
	...
	union DL_CCCH_MessageType_NB_u {
		struct DL_CCCH_MessageType_NB__c1 {
			...
			union DL_CCCH_MessageType_NB__c1_u {
				struct RRCConnectionReestablishment_NB	*rrcConnectionReestablishment_r13;
				struct RRCConnectionReestablishmentReject	*rrcConnectionReestablishmentReject_r13;
				struct RRCConnectionReject_NB	*rrcConnectionReject_r13;
				struct RRCConnectionSetup_NB	*rrcConnectionSetup_r13;
				struct RRCEarlyDataComplete_NB_r15	*rrcEarlyDataComplete_r15;
				NULL_t	 spare3;
				NULL_t	 spare2;
				NULL_t	 spare1;
			} choice;
