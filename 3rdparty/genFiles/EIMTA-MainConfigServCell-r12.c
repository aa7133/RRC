...
static asn_TYPE_member_t asn_MBR_mbsfn_SubframeConfigList_v1250_9[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct EIMTA_MainConfigServCell_r12__setup__mbsfn_SubframeConfigList_v1250, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_11,
		0,
...
asn_TYPE_member_t asn_MBR_EIMTA_MainConfigServCell_r12_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct EIMTA_MainConfigServCell_r12, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_3,
		0,
