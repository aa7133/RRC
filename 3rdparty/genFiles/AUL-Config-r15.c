...
asn_TYPE_descriptor_t asn_DEF_transmissionModeUL_AUL_r15_7 = {
	...
	{ 0, &asn_PER_type_transmissionModeUL_AUL_r15_constr_7, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_aul_StartingPartialBW_InsideMCOT_r15_12 = {
	...
	{ 0, &asn_PER_type_aul_StartingPartialBW_InsideMCOT_r15_constr_12, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_aul_StartingPartialBW_OutsideMCOT_r15_18 = {
	...
	{ 0, &asn_PER_type_aul_StartingPartialBW_OutsideMCOT_r15_constr_18, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_aul_RetransmissionTimer_r15_26 = {
	...
	{ 0, &asn_PER_type_aul_RetransmissionTimer_r15_constr_26, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_contentionWindowSizeTimer_r15_46 = {
	...
	{ 0, &asn_PER_type_contentionWindowSizeTimer_r15_constr_46, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
static asn_TYPE_member_t asn_MBR_setup_3[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct AUL_Config_r15__setup, aul_Subframes_r15),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_aul_Subframes_r15_constr_5,  memb_aul_Subframes_r15_constraint_3 },
		0, 0, /* No default value */
		"aul-Subframes-r15"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct AUL_Config_r15__setup, aul_HARQ_Processes_r15),
		...
		0,
		{ 0, &asn_PER_memb_aul_HARQ_Processes_r15_constr_6,  memb_aul_HARQ_Processes_r15_constraint_3 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct AUL_Config_r15__setup, aul_StartingFullBW_InsideMCOT_r15),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_aul_StartingFullBW_InsideMCOT_r15_constr_10,  memb_aul_StartingFullBW_InsideMCOT_r15_constraint_3 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct AUL_Config_r15__setup, aul_StartingFullBW_OutsideMCOT_r15),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_aul_StartingFullBW_OutsideMCOT_r15_constr_11,  memb_aul_StartingFullBW_OutsideMCOT_r15_constraint_3 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct AUL_Config_r15__setup, endingSymbolAUL_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_endingSymbolAUL_r15_constr_44,  memb_endingSymbolAUL_r15_constraint_3 },
		0, 0, /* No default value */
		"endingSymbolAUL-r15"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct AUL_Config_r15__setup, subframeOffsetCOT_Sharing_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_subframeOffsetCOT_Sharing_r15_constr_45,  memb_subframeOffsetCOT_Sharing_r15_constraint_3 },
		0, 0, /* No default value */
...
asn_TYPE_member_t asn_MBR_AUL_Config_r15_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct AUL_Config_r15, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_3,
		0,
...
asn_TYPE_descriptor_t asn_DEF_AUL_Config_r15 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_AUL_Config_r15_constr_1, CHOICE_constraint },
