...
static asn_TYPE_member_t asn_MBR_idc_Indication_MRDC_r15_31[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct IDC_Config_r11__ext3__idc_Indication_MRDC_r15, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
asn_TYPE_descriptor_t asn_DEF_idc_Indication_MRDC_r15_31 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_idc_Indication_MRDC_r15_constr_31, CHOICE_constraint },
