...
static asn_TYPE_member_t asn_MBR_criticalExtensions_3[] = {
	{ ATF_POINTER, 0, offsetof(struct RRCConnectionReconfigurationComplete__criticalExtensions, choice.rrcConnectionReconfigurationComplete_r8),
	...
	{ ATF_POINTER, 0, offsetof(struct RRCConnectionReconfigurationComplete__criticalExtensions, choice.criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
