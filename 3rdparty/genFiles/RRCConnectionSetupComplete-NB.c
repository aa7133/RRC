...
static asn_TYPE_member_t asn_MBR_criticalExtensions_3[] = {
	{ ATF_POINTER, 0, offsetof(struct RRCConnectionSetupComplete_NB__criticalExtensions, choice.rrcConnectionSetupComplete_r13),
	...
	{ ATF_POINTER, 0, offsetof(struct RRCConnectionSetupComplete_NB__criticalExtensions, choice.criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
