...
static asn_TYPE_member_t asn_MBR_schedulingCellInfo_r13_2[] = {
	{ ATF_POINTER, 0, offsetof(struct CrossCarrierSchedulingConfig_r13__schedulingCellInfo_r13, choice.own_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_own_r13_3,
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct CrossCarrierSchedulingConfig_r13__schedulingCellInfo_r13, choice.other_r13),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_other_r13_5,
		0,
