...
static asn_TYPE_member_t asn_MBR_n1PUCCH_AN_CS_v1130_2[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct PUCCH_ConfigDedicated_v1130__n1PUCCH_AN_CS_v1130, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_4,
		0,
...
static asn_TYPE_member_t asn_MBR_nPUCCH_Param_r11_7[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct PUCCH_ConfigDedicated_v1130__nPUCCH_Param_r11, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_9,
		0,
