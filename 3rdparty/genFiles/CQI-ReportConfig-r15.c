...
asn_TYPE_descriptor_t asn_DEF_altCQI_Table_1024QAM_r15_10 = {
	...
	{ 0, &asn_PER_type_altCQI_Table_1024QAM_r15_constr_10, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_CQI_ReportConfig_r15_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct CQI_ReportConfig_r15, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_3,
		0,
...
asn_TYPE_descriptor_t asn_DEF_CQI_ReportConfig_r15 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_CQI_ReportConfig_r15_constr_1, CHOICE_constraint },
