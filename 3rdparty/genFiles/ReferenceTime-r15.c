...
asn_TYPE_member_t asn_MBR_ReferenceTime_r15_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ReferenceTime_r15, refDays_r15),
		...
		0,
		{ 0, &asn_PER_memb_refDays_r15_constr_2,  memb_refDays_r15_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ReferenceTime_r15, refSeconds_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_refSeconds_r15_constr_3,  memb_refSeconds_r15_constraint_1 },
		0, 0, /* No default value */
		"refSeconds-r15"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct ReferenceTime_r15, refMilliSeconds_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_refMilliSeconds_r15_constr_4,  memb_refMilliSeconds_r15_constraint_1 },
		0, 0, /* No default value */
		"refMilliSeconds-r15"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct ReferenceTime_r15, refQuarterMicroSeconds_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_refQuarterMicroSeconds_r15_constr_5,  memb_refQuarterMicroSeconds_r15_constraint_1 },
		0, 0, /* No default value */
