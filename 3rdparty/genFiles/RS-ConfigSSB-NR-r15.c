...
asn_TYPE_descriptor_t asn_DEF_subcarrierSpacingSSB_r15_3 = {
	...
	{ 0, &asn_PER_type_subcarrierSpacingSSB_r15_constr_3, NativeEnumerated_constraint },
...
static asn_TYPE_member_t asn_MBR_ssb_ToMeasure_r15_10[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct RS_ConfigSSB_NR_r15__ext1__ssb_ToMeasure_r15, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
...
asn_TYPE_descriptor_t asn_DEF_ssb_ToMeasure_r15_10 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_ssb_ToMeasure_r15_constr_10, CHOICE_constraint },
