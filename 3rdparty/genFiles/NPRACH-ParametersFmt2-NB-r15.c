...
asn_TYPE_descriptor_t asn_DEF_nprach_SubcarrierOffset_r15_21 = {
	...
	{ 0, &asn_PER_type_nprach_SubcarrierOffset_r15_constr_21, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
static asn_TYPE_member_t asn_MBR_nprach_Parameters_r15_2[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct NPRACH_ParametersFmt2_NB_r15__nprach_Parameters_r15, npdcch_CarrierIndex_r15),
		...
		0,
		{ 0, &asn_PER_memb_npdcch_CarrierIndex_r15_constr_96,  memb_npdcch_CarrierIndex_r15_constraint_2 },
		0, 0, /* No default value */
