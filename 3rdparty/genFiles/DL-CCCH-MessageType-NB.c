...
static asn_TYPE_member_t asn_MBR_c1_2[] = {
	{ ATF_POINTER, 0, offsetof(struct DL_CCCH_MessageType_NB__c1, choice.rrcConnectionReestablishment_r13),
	...
	{ ATF_POINTER, 0, offsetof(struct DL_CCCH_MessageType_NB__c1, choice.rrcConnectionReestablishmentReject_r13),
	...
	{ ATF_POINTER, 0, offsetof(struct DL_CCCH_MessageType_NB__c1, choice.rrcConnectionReject_r13),
	...
	{ ATF_POINTER, 0, offsetof(struct DL_CCCH_MessageType_NB__c1, choice.rrcConnectionSetup_r13),
	...
	{ ATF_POINTER, 0, offsetof(struct DL_CCCH_MessageType_NB__c1, choice.rrcEarlyDataComplete_r15),
...
asn_TYPE_member_t asn_MBR_DL_CCCH_MessageType_NB_1[] = {
	{ ATF_POINTER, 0, offsetof(struct DL_CCCH_MessageType_NB, choice.c1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 0, offsetof(struct DL_CCCH_MessageType_NB, choice.messageClassExtension),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
