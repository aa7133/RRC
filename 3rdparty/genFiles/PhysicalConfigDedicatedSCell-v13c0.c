...
static asn_TYPE_member_t asn_MBR_pucch_SCell_v13c0_2[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct PhysicalConfigDedicatedSCell_v13c0__pucch_SCell_v13c0, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_4,
		0,
...
asn_TYPE_descriptor_t asn_DEF_pucch_SCell_v13c0_2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_pucch_SCell_v13c0_constr_2, CHOICE_constraint },
