...
static asn_TYPE_member_t asn_MBR_downlinkBitmapNonAnchor_r14_3[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct DL_CarrierConfigCommon_NB_r14__downlinkBitmapNonAnchor_r14, choice.explicitBitmapConfiguration_r14),
...
static asn_TYPE_member_t asn_MBR_dl_GapNonAnchor_r14_7[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct DL_CarrierConfigCommon_NB_r14__dl_GapNonAnchor_r14, choice.explicitGapConfiguration_r14),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_TYPE_member_t asn_MBR_samePCI_Indicator_r14_12[] = {
	{ ATF_POINTER, 0, offsetof(struct DL_CarrierConfigCommon_NB_r14__inbandCarrierInfo_r14__samePCI_Indicator_r14, choice.samePCI_r14),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct DL_CarrierConfigCommon_NB_r14__inbandCarrierInfo_r14__samePCI_Indicator_r14, choice.differentPCI_r14),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
