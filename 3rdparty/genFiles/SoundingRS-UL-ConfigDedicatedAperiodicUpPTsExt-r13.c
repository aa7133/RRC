...
static asn_TYPE_member_t asn_MBR_srs_ActivateAp_r13_10[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct SoundingRS_UL_ConfigDedicatedAperiodicUpPTsExt_r13__setup__srs_ActivateAp_r13, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_12,
		0,
...
asn_TYPE_member_t asn_MBR_SoundingRS_UL_ConfigDedicatedAperiodicUpPTsExt_r13_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct SoundingRS_UL_ConfigDedicatedAperiodicUpPTsExt_r13, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_3,
		0,
