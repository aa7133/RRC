...
static asn_TYPE_member_t asn_MBR_c1_3[] = {
	{ ATF_POINTER, 0, offsetof(struct ULInformationTransfer__criticalExtensions__c1, choice.ulInformationTransfer_r8),
...
static asn_TYPE_member_t asn_MBR_criticalExtensions_2[] = {
	{ ATF_POINTER, 0, offsetof(struct ULInformationTransfer__criticalExtensions, choice.c1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
