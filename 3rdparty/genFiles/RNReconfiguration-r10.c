...
static asn_TYPE_member_t asn_MBR_c1_4[] = {
	{ ATF_POINTER, 0, offsetof(struct RNReconfiguration_r10__criticalExtensions__c1, choice.rnReconfiguration_r10),
...
static asn_TYPE_member_t asn_MBR_criticalExtensions_3[] = {
	{ ATF_POINTER, 0, offsetof(struct RNReconfiguration_r10__criticalExtensions, choice.c1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 0, offsetof(struct RNReconfiguration_r10__criticalExtensions, choice.criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
