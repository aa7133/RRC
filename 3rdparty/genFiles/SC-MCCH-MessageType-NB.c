...
static asn_TYPE_member_t asn_MBR_c1_2[] = {
	{ ATF_POINTER, 0, offsetof(struct SC_MCCH_MessageType_NB__c1, choice.scptmConfiguration_r14),
...
asn_TYPE_member_t asn_MBR_SC_MCCH_MessageType_NB_1[] = {
	{ ATF_POINTER, 0, offsetof(struct SC_MCCH_MessageType_NB, choice.c1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 0, offsetof(struct SC_MCCH_MessageType_NB, choice.messageClassExtension),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
