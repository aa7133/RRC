...
static asn_TYPE_member_t asn_MBR_c1_4[] = {
	{ ATF_POINTER, 0, offsetof(struct RRCConnectionSetup__criticalExtensions__c1, choice.rrcConnectionSetup_r8),
...
static asn_TYPE_member_t asn_MBR_criticalExtensions_3[] = {
	{ ATF_POINTER, 0, offsetof(struct RRCConnectionSetup__criticalExtensions, choice.c1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 0, offsetof(struct RRCConnectionSetup__criticalExtensions, choice.criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
