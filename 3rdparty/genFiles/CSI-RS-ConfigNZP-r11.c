...
static asn_TYPE_member_t asn_MBR_mbsfn_SubframeConfigList_r11_18[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct CSI_RS_ConfigNZP_r11__qcl_CRS_Info_r11__mbsfn_SubframeConfigList_r11, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_20,
		0,
...
static asn_TYPE_member_t asn_MBR_mbsfn_SubframeConfigList_v1430_29[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct CSI_RS_ConfigNZP_r11__ext3__mbsfn_SubframeConfigList_v1430, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_31,
		0,
