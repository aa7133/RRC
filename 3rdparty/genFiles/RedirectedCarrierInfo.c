...
asn_TYPE_member_t asn_MBR_RedirectedCarrierInfo_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct RedirectedCarrierInfo, choice.geran),
	...
	{ ATF_POINTER, 0, offsetof(struct RedirectedCarrierInfo, choice.cdma2000_HRPD),
	...
	{ ATF_POINTER, 0, offsetof(struct RedirectedCarrierInfo, choice.cdma2000_1xRTT),
	...
	{ ATF_POINTER, 0, offsetof(struct RedirectedCarrierInfo, choice.utra_TDD_r10),
	...
	{ ATF_POINTER, 0, offsetof(struct RedirectedCarrierInfo, choice.nr_r15),
