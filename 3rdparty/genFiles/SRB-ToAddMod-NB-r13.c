...
static asn_TYPE_member_t asn_MBR_rlc_Config_r13_2[] = {
	{ ATF_POINTER, 0, offsetof(struct SRB_ToAddMod_NB_r13__rlc_Config_r13, choice.explicitValue),
...
static asn_TYPE_member_t asn_MBR_logicalChannelConfig_r13_5[] = {
	{ ATF_POINTER, 0, offsetof(struct SRB_ToAddMod_NB_r13__logicalChannelConfig_r13, choice.explicitValue),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
