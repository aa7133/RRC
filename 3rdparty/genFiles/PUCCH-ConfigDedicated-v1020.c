...
static asn_TYPE_member_t asn_MBR_n1PUCCH_AN_CS_r10_5[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct PUCCH_ConfigDedicated_v1020__pucch_Format_r10__channelSelection_r10__n1PUCCH_AN_CS_r10, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_7,
		0,
...
static asn_TYPE_member_t asn_MBR_pucch_Format_r10_2[] = {
	{ ATF_POINTER, 0, offsetof(struct PUCCH_ConfigDedicated_v1020__pucch_Format_r10, choice.format3_r10),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 0, offsetof(struct PUCCH_ConfigDedicated_v1020__pucch_Format_r10, choice.channelSelection_r10),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
