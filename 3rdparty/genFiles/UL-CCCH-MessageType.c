...
static asn_TYPE_member_t asn_MBR_c1_2[] = {
	{ ATF_POINTER, 0, offsetof(struct UL_CCCH_MessageType__c1, choice.rrcConnectionReestablishmentRequest),
	...
	{ ATF_POINTER, 0, offsetof(struct UL_CCCH_MessageType__c1, choice.rrcConnectionRequest),
...
static asn_TYPE_member_t asn_MBR_c2_6[] = {
	{ ATF_POINTER, 0, offsetof(struct UL_CCCH_MessageType__messageClassExtension__c2, choice.rrcConnectionResumeRequest_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_TYPE_member_t asn_MBR_c3_9[] = {
	{ ATF_POINTER, 0, offsetof(struct UL_CCCH_MessageType__messageClassExtension__messageClassExtensionFuture_r13__c3, choice.rrcEarlyDataRequest_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
asn_TYPE_descriptor_t asn_DEF_c3_9 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_c3_constr_9, CHOICE_constraint },
	asn_MBR_c3_9,
	4,	/* Elements count */
...
static asn_TYPE_member_t asn_MBR_messageClassExtensionFuture_r13_8[] = {
	{ ATF_POINTER, 0, offsetof(struct UL_CCCH_MessageType__messageClassExtension__messageClassExtensionFuture_r13, choice.c3),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 0, offsetof(struct UL_CCCH_MessageType__messageClassExtension__messageClassExtensionFuture_r13, choice.messageClassExtensionFuture_r15),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
asn_TYPE_descriptor_t asn_DEF_messageClassExtensionFuture_r13_8 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_messageClassExtensionFuture_r13_constr_8, CHOICE_constraint },
...
static asn_TYPE_member_t asn_MBR_messageClassExtension_5[] = {
	{ ATF_POINTER, 0, offsetof(struct UL_CCCH_MessageType__messageClassExtension, choice.c2),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_c2_6,
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct UL_CCCH_MessageType__messageClassExtension, choice.messageClassExtensionFuture_r13),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		+1,	/* EXPLICIT tag at current level */
