...
asn_TYPE_descriptor_t asn_DEF_spdcch_SetReferenceSig_r15_5 = {
	...
	{ 0, &asn_PER_type_spdcch_SetReferenceSig_r15_constr_5, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_transmissionType_r15_8 = {
	...
	{ 0, &asn_PER_type_transmissionType_r15_constr_8, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_dci7_CandidatesPerAL_PDCCH_r15_13 = {
	...
	{ 0, &asn_PER_type_dci7_CandidatesPerAL_PDCCH_r15_constr_13, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_dci7_CandidateSetsPerAL_SPDCCH_r15_15 = {
	...
	{ 0, &asn_PER_type_dci7_CandidateSetsPerAL_SPDCCH_r15_constr_15, SEQUENCE_OF_constraint },
...
static asn_TYPE_member_t asn_MBR_resourceBlockAssignment_r15_17[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SPDCCH_Elements_r15__setup__resourceBlockAssignment_r15, numberRB_InFreq_domain_r15),
		...
		0,
		{ 0, &asn_PER_memb_numberRB_InFreq_domain_r15_constr_18,  memb_numberRB_InFreq_domain_r15_constraint_17 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SPDCCH_Elements_r15__setup__resourceBlockAssignment_r15, resourceBlockAssignment_r15),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_resourceBlockAssignment_r15_constr_19,  memb_resourceBlockAssignment_r15_constraint_17 },
		0, 0, /* No default value */
...
asn_TYPE_descriptor_t asn_DEF_al_StartingPointSPDCCH_r15_21 = {
	...
	{ 0, &asn_PER_type_al_StartingPointSPDCCH_r15_constr_21, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_subframeType_r15_23 = {
	...
	{ 0, &asn_PER_type_subframeType_r15_constr_23, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_rateMatchingMode_r15_27 = {
	...
	{ 0, &asn_PER_type_rateMatchingMode_r15_constr_27, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
static asn_TYPE_member_t asn_MBR_setup_3[] = {
	{ ATF_POINTER, 12, offsetof(struct SPDCCH_Elements_r15__setup, spdcch_SetConfigId_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_spdcch_SetConfigId_r15_constr_4,  memb_spdcch_SetConfigId_r15_constraint_3 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 9, offsetof(struct SPDCCH_Elements_r15__setup, spdcch_NoOfSymbols_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_spdcch_NoOfSymbols_r15_constr_11,  memb_spdcch_NoOfSymbols_r15_constraint_3 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 8, offsetof(struct SPDCCH_Elements_r15__setup, dmrs_ScramblingSequenceInt_r15),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_dmrs_ScramblingSequenceInt_r15_constr_12,  memb_dmrs_ScramblingSequenceInt_r15_constraint_3 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 7, offsetof(struct SPDCCH_Elements_r15__setup, dci7_CandidatesPerAL_PDCCH_r15),
		...
		0,
		{ 0, &asn_PER_memb_dci7_CandidatesPerAL_PDCCH_r15_constr_13,  memb_dci7_CandidatesPerAL_PDCCH_r15_constraint_3 },
		0, 0, /* No default value */
		"dci7-CandidatesPerAL-PDCCH-r15"
		},
	{ ATF_POINTER, 6, offsetof(struct SPDCCH_Elements_r15__setup, dci7_CandidateSetsPerAL_SPDCCH_r15),
		...
		0,
		{ 0, &asn_PER_memb_dci7_CandidateSetsPerAL_SPDCCH_r15_constr_15,  memb_dci7_CandidateSetsPerAL_SPDCCH_r15_constraint_3 },
		0, 0, /* No default value */
		"dci7-CandidateSetsPerAL-SPDCCH-r15"
		},
	...
	{ ATF_POINTER, 4, offsetof(struct SPDCCH_Elements_r15__setup, subslotApplicability_r15),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_subslotApplicability_r15_constr_20,  memb_subslotApplicability_r15_constraint_3 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 3, offsetof(struct SPDCCH_Elements_r15__setup, al_StartingPointSPDCCH_r15),
		...
		0,
		{ 0, &asn_PER_memb_al_StartingPointSPDCCH_r15_constr_21,  memb_al_StartingPointSPDCCH_r15_constraint_3 },
		0, 0, /* No default value */
		"al-StartingPointSPDCCH-r15"
		},
...
asn_TYPE_member_t asn_MBR_SPDCCH_Elements_r15_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct SPDCCH_Elements_r15, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_3,
		0,
...
asn_TYPE_descriptor_t asn_DEF_SPDCCH_Elements_r15 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_SPDCCH_Elements_r15_constr_1, CHOICE_constraint },
