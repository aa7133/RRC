...
static asn_TYPE_member_t asn_MBR_measObject_3[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct MeasObjectToAddMod__measObject, choice.measObjectUTRA),
	...
	{ ATF_POINTER, 0, offsetof(struct MeasObjectToAddMod__measObject, choice.measObjectGERAN),
	...
	{ ATF_POINTER, 0, offsetof(struct MeasObjectToAddMod__measObject, choice.measObjectCDMA2000),
	...
	{ ATF_POINTER, 0, offsetof(struct MeasObjectToAddMod__measObject, choice.measObjectWLAN_r13),
	...
	{ ATF_POINTER, 0, offsetof(struct MeasObjectToAddMod__measObject, choice.measObjectNR_r15),
