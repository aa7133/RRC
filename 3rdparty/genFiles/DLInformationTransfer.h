...
struct DLInformationTransfer_r8_IEs;
struct DLInformationTransfer_r15_IEs;
		...
		union DLInformationTransfer__criticalExtensions_u {
			struct DLInformationTransfer__criticalExtensions__c1 {
				...
				union DLInformationTransfer__criticalExtensions__c1_u {
					struct DLInformationTransfer_r8_IEs	*dlInformationTransfer_r8;
					struct DLInformationTransfer_r15_IEs	*dlInformationTransfer_r15;
					NULL_t	 spare2;
					NULL_t	 spare1;
				} choice;
