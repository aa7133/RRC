...
struct SystemInformation_MBMS_r14;
struct SystemInformationBlockType1_MBMS_r14;
	...
	union BCCH_DL_SCH_MessageType_MBMS_r14_u {
		struct BCCH_DL_SCH_MessageType_MBMS_r14__c1 {
			...
			union BCCH_DL_SCH_MessageType_MBMS_r14__c1_u {
				struct SystemInformation_MBMS_r14	*systemInformation_MBMS_r14;
				struct SystemInformationBlockType1_MBMS_r14	*systemInformationBlockType1_MBMS_r14;
			} choice;
