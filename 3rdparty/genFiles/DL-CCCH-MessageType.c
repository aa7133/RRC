...
static asn_TYPE_member_t asn_MBR_c1_2[] = {
	{ ATF_POINTER, 0, offsetof(struct DL_CCCH_MessageType__c1, choice.rrcConnectionReestablishment),
	...
	{ ATF_POINTER, 0, offsetof(struct DL_CCCH_MessageType__c1, choice.rrcConnectionReestablishmentReject),
	...
	{ ATF_POINTER, 0, offsetof(struct DL_CCCH_MessageType__c1, choice.rrcConnectionReject),
	...
	{ ATF_POINTER, 0, offsetof(struct DL_CCCH_MessageType__c1, choice.rrcConnectionSetup),
...
static asn_TYPE_member_t asn_MBR_c2_8[] = {
	{ ATF_POINTER, 0, offsetof(struct DL_CCCH_MessageType__messageClassExtension__c2, choice.rrcEarlyDataComplete_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
asn_TYPE_descriptor_t asn_DEF_c2_8 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_c2_constr_8, CHOICE_constraint },
	asn_MBR_c2_8,
	4,	/* Elements count */
...
static asn_TYPE_member_t asn_MBR_messageClassExtension_7[] = {
	{ ATF_POINTER, 0, offsetof(struct DL_CCCH_MessageType__messageClassExtension, choice.c2),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 0, offsetof(struct DL_CCCH_MessageType__messageClassExtension, choice.messageClassExtensionFuture_r15),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
asn_TYPE_descriptor_t asn_DEF_messageClassExtension_7 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_messageClassExtension_constr_7, CHOICE_constraint },
