...
static asn_TYPE_member_t asn_MBR_setup_3[] = {
	{ ATF_POINTER, 0, offsetof(struct CSI_RS_ConfigEMIMO_v1430__setup, choice.nonPrecoded_v1430),
	...
	{ ATF_POINTER, 0, offsetof(struct CSI_RS_ConfigEMIMO_v1430__setup, choice.beamformed_v1430),
...
asn_TYPE_member_t asn_MBR_CSI_RS_ConfigEMIMO_v1430_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct CSI_RS_ConfigEMIMO_v1430, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
