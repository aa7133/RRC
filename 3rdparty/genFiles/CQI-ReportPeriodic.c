...
static asn_TYPE_member_t asn_MBR_cqi_FormatIndicatorPeriodic_6[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct CQI_ReportPeriodic__setup__cqi_FormatIndicatorPeriodic, choice.subbandCQI),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
asn_TYPE_member_t asn_MBR_CQI_ReportPeriodic_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct CQI_ReportPeriodic, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_3,
		0,
