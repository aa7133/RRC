...
static asn_TYPE_member_t asn_MBR_schedulingCellInfo_r10_2[] = {
	{ ATF_POINTER, 0, offsetof(struct CrossCarrierSchedulingConfig_r10__schedulingCellInfo_r10, choice.own_r10),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_own_r10_3,
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct CrossCarrierSchedulingConfig_r10__schedulingCellInfo_r10, choice.other_r10),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_other_r10_5,
		0,
