...
static asn_TYPE_member_t asn_MBR_csi_IM_ConfigIdList_r12_13[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct CSI_Process_r11__ext1__csi_IM_ConfigIdList_r12, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_15,
		0,
...
static asn_TYPE_member_t asn_MBR_cqi_ReportAperiodicProc2_r12_17[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct CSI_Process_r11__ext1__cqi_ReportAperiodicProc2_r12, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_TYPE_member_t asn_MBR_cqi_ReportAperiodicProc_v1310_21[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct CSI_Process_r11__ext2__cqi_ReportAperiodicProc_v1310, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_TYPE_member_t asn_MBR_cqi_ReportAperiodicProc2_v1310_24[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct CSI_Process_r11__ext2__cqi_ReportAperiodicProc2_v1310, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_CQI_ReportAperiodicProc_v1310,
		0,
