...
static asn_TYPE_member_t asn_MBR_criticalExtensions_3[] = {
	{ ATF_POINTER, 0, offsetof(struct RRCConnectionResumeComplete_r13__criticalExtensions, choice.rrcConnectionResumeComplete_r13),
	...
	{ ATF_POINTER, 0, offsetof(struct RRCConnectionResumeComplete_r13__criticalExtensions, choice.criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
