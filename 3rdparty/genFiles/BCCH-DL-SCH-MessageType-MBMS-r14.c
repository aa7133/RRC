...
static asn_TYPE_member_t asn_MBR_c1_2[] = {
	{ ATF_POINTER, 0, offsetof(struct BCCH_DL_SCH_MessageType_MBMS_r14__c1, choice.systemInformation_MBMS_r14),
	...
	{ ATF_POINTER, 0, offsetof(struct BCCH_DL_SCH_MessageType_MBMS_r14__c1, choice.systemInformationBlockType1_MBMS_r14),
...
asn_TYPE_member_t asn_MBR_BCCH_DL_SCH_MessageType_MBMS_r14_1[] = {
	{ ATF_POINTER, 0, offsetof(struct BCCH_DL_SCH_MessageType_MBMS_r14, choice.c1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 0, offsetof(struct BCCH_DL_SCH_MessageType_MBMS_r14, choice.messageClassExtension),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
