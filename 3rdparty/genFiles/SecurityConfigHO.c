...
static asn_TYPE_member_t asn_MBR_handoverType_2[] = {
	{ ATF_POINTER, 0, offsetof(struct SecurityConfigHO__handoverType, choice.intraLTE),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_intraLTE_3,
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct SecurityConfigHO__handoverType, choice.interRAT),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_interRAT_7,
		0,
