...
static asn_TYPE_member_t asn_MBR_delayBudgetReportingConfig_r14_27[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct OtherConfig_r9__ext2__delayBudgetReportingConfig_r14, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_29,
		0,
...
static asn_TYPE_member_t asn_MBR_rlm_ReportConfig_r14_39[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct OtherConfig_r9__ext2__rlm_ReportConfig_r14, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_41,
		0,
...
static asn_TYPE_member_t asn_MBR_overheatingAssistanceConfig_r14_62[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct OtherConfig_r9__ext3__overheatingAssistanceConfig_r14, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_64,
		0,
...
asn_TYPE_descriptor_t asn_DEF_serviceType_87 = {
	...
	{ 0, &asn_PER_type_serviceType_constr_87, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
static asn_TYPE_member_t asn_MBR_setup_85[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct OtherConfig_r9__ext4__measConfigAppLayer_r15__setup, measConfigAppLayerContainer_r15),
		...
		0,
		{ 0, &asn_PER_memb_measConfigAppLayerContainer_r15_constr_86,  memb_measConfigAppLayerContainer_r15_constraint_85 },
		0, 0, /* No default value */
...
static asn_TYPE_member_t asn_MBR_measConfigAppLayer_r15_83[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct OtherConfig_r9__ext4__measConfigAppLayer_r15, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_85,
		0,
...
asn_TYPE_descriptor_t asn_DEF_measConfigAppLayer_r15_83 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_measConfigAppLayer_r15_constr_83, CHOICE_constraint },
